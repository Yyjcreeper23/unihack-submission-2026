              ...
              <div key={rarity} style={{ marginBottom: 20 }}>
                ...
                <div style={{
                  ...
                  <span style={{
                    ...
                    {monsters.filter(m => ownedMonsterIds.includes(m.id)).length}/{monsters.length}
                  </span>
                </div>
      ...
      <div style={{ position: "relative", width: 52, height: 52 }}>
        <img
          ...
          style={{
            ...
            filter:         owned
              ? hovered ? `drop-shadow(0 0 6px ${rarityColor})` : "none"
              : "brightness(0)",
